...
# Purpose:
#
# IT checklist, Application/Coordination #5: "Have standard environment
# variables been used throughout the entire package?"
#
...
do
 ...
 done < <(nocomment_dummy.sh $f | grep -E --line-number '\$\{?\w+\}?')
